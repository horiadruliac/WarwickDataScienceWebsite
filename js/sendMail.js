...
function validateForm() {
  ...
  if (name.length == 0 || name == "") {
    errors = true;
    document.getElementById("nameError").outerHTML = nameError.replace('data-error=""', 'data-error="Details Missing"');
  ...
  if (email == "") {
    errors = true;
    document.getElementById("emailError").outerHTML = emailError.replace('data-error=""', 'data-error="Details Missing"');
  ...
  if (message == "") {
    errors = true;
    document.getElementById("messageError").outerHTML = messageError.replace('data-error=""', 'data-error="Details Missing"');
